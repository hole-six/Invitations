...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-row-reverse">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-purple-50 to-indigo-100 overflow-hidden">
        {/* Background Image */}
        <img 
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-indigo-400 to-purple-500 hover:from-indigo-500 hover:to-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              {loading ? (
                <>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="font-medium text-indigo-400 hover:text-indigo-500 transition">
              Sign in
            </Link>
          </p>
        </div>
