...
const MediaLibraryModal = ({ onSelectImage, onClose }) => {
  ...
  const loadImages = async (page = 1) => {
    try {
      ...
      // Load server images only
      const serverResponse = await mediaService.getAll({ page, limit: 20 }).catch(() => ({ data: [] }))
      ...
      const allImages = [...serverImages].sort((a, b) =>
  ...
  const handleUpload = async (files) => {
    ...
    try {
      console.log('🚀 Starting S3 upload flow')
      ...
      for (const file of files) {
        try {
          ...
          const serverFileEntry = {
            ...
            url: uploadResult.final_url || uploadResult.url,
            name: file.name,
            size: file.size,
      ...
      if (successCount > 0) {
        toast.success(`✅ Đã tải ${successCount} ảnh thành công!`)
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-6 py-2.5 rounded-lg font-semibold text-sm transition-all ${activeTab === 'library'
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-lg font-semibold text-sm transition-all ${activeTab === 'upload'
                  ? 'bg-primary text-white shadow-lg'
                  : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700'
                }`}
            >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800 mb-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-semibold text-blue-900 dark:text-blue-100">S3 Cloud Upload</span>
                </div>
                <div className="text-xs text-blue-800 dark:text-blue-200 space-y-1">
                  <p>• Tải ảnh trực tiếp lên Cloud Server an toàn</p>
                  <p>• Hỗ trợ tất cả định dạng ảnh phổ biến (JPG, PNG, WebP)</p>
                  <p>• Ảnh được lưu trữ vĩnh viễn trong tài khoản của bạn</p>
                </div>
              </div>
