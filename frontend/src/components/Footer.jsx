          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="font-serif text-xl font-bold leading-none tracking-wide text-gray-900 text-white">HIWEB</span>
                <span className="text-[10px] uppercase tracking-[0.2em] opacity-60  text-white-400">.VN</span>
              </div>
            </Link>
            <p className="text-sm text-gray-400">
              Tạo thiệp mời điện tử đẹp mắt, chuyên nghiệp cho mọi sự kiện của bạn.
            </p>
          </div>
